...
class OrbitCamera(Camera):
    def __init__(self, distance, camera_type = Camera.PERSPECTIVE):
...
class FreeCamera(Camera):
    def __init__(self, position = [0, 0, 0], camera_type = Camera.PERSPECTIVE):
        super().__init__(camera_type)
